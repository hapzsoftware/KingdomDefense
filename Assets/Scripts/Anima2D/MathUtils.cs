...
namespace Anima2D
{
	public static class MathUtils
	{
		...
		public static Vector3 Unskin(Vector3 skinedPosition, Matrix4x4 localToWorld, BoneWeight boneWeight, Matrix4x4[] bindposes, Transform[] bones)
		{
			...
			{
				int index;
				matrix4x[index = i] = matrix4x[index] * boneWeight.weight0;
				int index2;
				matrix4x2[index2 = i] = matrix4x2[index2] * boneWeight.weight1;
				int index3;
				matrix4x3[index3 = i] = matrix4x3[index3] * boneWeight.weight2;
				int index4;
				matrix4x4[index4 = i] = matrix4x4[index4] * boneWeight.weight3;
